...
//                  1UINavigationBar.appearance().titleTextAttributes = [NSForegroundColorAttributeName : UIColor.brightPinkColor(), NSFontAttributeName : UIFont(name: "Budmo", size: 30.0)]
        ...
        var attr = NSDictionary(object: UIFont(name: "Oswald Regular", size: 14.0)!, forKey: NSFontAttributeName)
...
//        self.window?.rootViewController?.view .addSubview(addStatusBar)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.supernova8.SwiftToDo" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("CluelessCloset", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("CluelessCloset.sqlite")
        var error: NSError? = nil
        var failureReason = "There was an error creating or loading the application's saved data."
        
        
        // add this line and change options in line below from nil
