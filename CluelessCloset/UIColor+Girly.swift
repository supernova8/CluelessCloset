...
//    }
    ...
    // MARK: - Flat colors
    class func brightTurqColor() -> UIColor {
        return UIColor(red: 166.0/255.0, green: 244.0/255.0, blue:211.0/255.0, alpha: 1.0)
    }
    
    class func tealColor() -> UIColor {
        return UIColor(red: 147.0/255.0, green: 218.0/255.0, blue: 188.0/255.0, alpha: 1.0)
    }
    
    class func brightPinkColor() -> UIColor {
